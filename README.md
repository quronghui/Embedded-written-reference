...
4. [嵌入式系统中，要求程序员去访问某特定的内存位置?](/OS/访问固定的内存位置.md)
6. [单片机应用程序存放的位置？单片机应用程序的三种架构？](/C/单片机应用程序架构.md)
7. [IGBT是什么控制性原件？](/C/IGBT是什么控制性原件.md)
8. [看门狗程序是为了溢出而设置的复位点，放在哪个位置？](/C/看门狗程序的应用.md)
9. [单片机中程序计数器PC是16bit，其寻址范围是多少？](/C/PC寻址范围.md)
...
24. [对于一个频繁使用的短小函数，c/c++用的什么？](/C/C对于一个频繁使用的短小函数.md)
